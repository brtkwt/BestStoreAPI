...
namespace BestStoreAPI.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public IActionResult GetOrders(int? page)
        {
            ...
            IQueryable<Order> query = context.Orders.Include(o => o.User).Include(o => o.OrderItems)
                .ThenInclude(oi => oi.Product);

            //include - include navigation property of the order model
            //theninclude - include property of the orderitem
